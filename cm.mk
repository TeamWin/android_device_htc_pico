...
$(call inherit-product-if-exists, device/common/gps/gps_eu_supl.mk)
...
PRODUCT_BUILD_PROP_OVERRIDES += PRODUCT_NAME=pico BUILD_ID=MOB30D BUILD_FINGERPRINT=htc_europe/htc_pico/pico:6.0.1/MOB30D/87995:user/release-keys
